#!/usr/bin/env bash
# One-time 2023 Sidearm backfill (D1/D2/D3/NAIA): rosters + schedules +
...
#   nohup nice -n 15 bash scripts/backfill_2024_sidearm.sh > /tmp/bf2023.log 2>&1 &
#
...
banner "DONE — 2023 Sidearm backfill complete"
