...
export default function TournamentBracketGraphic() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      <h1 className="text-2xl font-bold text-nw-teal dark:text-gray-100 mb-1">Conference Tournament Bracket</h1>
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4">
        ...
        <button
          ...
          className="px-4 py-2 rounded-lg bg-nw-teal text-white text-sm font-semibold
                     hover:bg-nw-teal disabled:opacity-40 disabled:cursor-not-allowed"
        >
          Download PNG
        </button>
