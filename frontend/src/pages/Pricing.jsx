...
const TIERS = [
  {
    ...
    highlights: [
      ...
      'Recruit Matchmaker (your #1 program fit)',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Recruiting Boards (build boards, share by email or link)',
      'All games: PNW Grid, FieldGuessr, PNW Pickle, Team Quiz',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Recruit Finder (filter uncommitted targets by stats)',
      'Commitments tracker',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Covers your whole staff: 3 extra seats included',
...
const FEATURES = [
  ...
  { feat: 'All-Conference Generator + Playoff Projections',
                                               tiers: { none: false, free: true, premium: true, recruiting: true, coach: true } },
  { feat: 'Recruiting Boards (build boards, share by email or public link)',
                                               tiers: { none: false, free: true, premium: true, recruiting: true, coach: true } },
  ...
  { feat: 'Recruit Matchmaker: your #1 program fit (free for everyone)',
                                               tiers: { none: true, free: true, premium: true, recruiting: true, coach: true } },
  { feat: 'Recruit Matchmaker: full ranked list (best fit at every level)',
                                               tiers: { none: false, free: false, premium: true, recruiting: true, coach: true } },
  { feat: 'NWAC Advancement guide',            tiers: { none: false, free: false, premium: true, recruiting: true, coach: true } },
  ...
  { feat: 'WCL Transfer Portal Tracker (summer-ball portal, WCL stats)',
                                               tiers: { none: false, free: false, premium: false, recruiting: true, coach: true } },
  { feat: 'Recruit Finder (uncommitted targets by position, archetype & stat filters)',
                                               tiers: { none: false, free: false, premium: false, recruiting: true, coach: true } },
  { feat: 'Advanced hitter & pitcher discipline stats',
                                               tiers: { none: false, free: false, premium: false, recruiting: true, coach: true } },

  { section: 'Coach & Scout Portal ($25/mo)' },
  { feat: 'Share your subscription with your staff (3 extra seats)',
                                               tiers: { none: false, free: false, premium: false, recruiting: false, coach: true } },
  { feat: 'Series Planner (pre-series game plan: identity, Big 3, pitcher attack)',
                                               tiers: { none: false, free: false, premium: false, recruiting: false, coach: true } },
  { feat: 'Defensive Alignments (per-hitter spray + fielder shift calls)',
                                               tiers: { none: false, free: false, premium: false, recruiting: false, coach: true } },
  { feat: 'Defensive Card (one-page shift grid for the whole lineup)',
                                               tiers: { none: false, free: false, premium: false, recruiting: false, coach: true } },
  { feat: 'Custom Player Card builder (starter templates, saved layouts, bulk rosters)',
                                               tiers: { none: false, free: false, premium: false, recruiting: false, coach: true } },
  { feat: 'Custom Sheet builder (pick your filters + stat columns)',
                                               tiers: { none: false, free: false, premium: false, recruiting: false, coach: true } },
  { feat: 'Splits Explorer (any team by game state, count, hand, home/away)',
                                               tiers: { none: false, free: false, premium: false, recruiting: false, coach: true } },
  { feat: 'Trends (lineups, rotation, bullpen usage, times-thru-order)',
                                               tiers: { none: false, free: false, premium: false, recruiting: false, coach: true } },
  { feat: 'Lineup Helper (vs RHP / LHP, bench)',
                                               tiers: { none: false, free: false, premium: false, recruiting: false, coach: true } },
  { feat: 'Rapsodo Lab (bullpen CSVs to pitch profiles & movement)',
                                               tiers: { none: false, free: false, premium: false, recruiting: false, coach: true } },
