    ...
    <div>
      ...
      <Card title="Advanced Pitching Stats" subtitle="Defense-independent and predictive metrics">
        ...
        <StatDef abbr="kwERA" name="Strikeout-Walk ERA">
          The simplest ERA estimator: 5.40 - 12 × ((K - BB) / BF). Uses only strikeouts and walks. Less precise than FIP or SIERA but useful as a quick sanity check because it relies on the most reliable, defense-independent stats.
        </StatDef>
...
function EnvironmentSection() {
  return (
    <div>
      ...
      <Card title="NCAA Division I" subtitle="Pac-12, Big Ten, WCC, Mountain West, WAC">
        <P>
          D1 is the highest level of college baseball in the PNW. These programs feature the best pitching, with average strikeout rates near 10 K/9 and the lowest walk rates. The run environment is moderate — scoring is lower than D2/D3/NAIA partly because of the quality of arms, defense, and scouting at this level. D1 programs also play the most non-conference games against other high-level opponents, further suppressing batting stats.
        </P>
        <div className="grid grid-cols-2 gap-3 my-3 text-center">
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">.268</p><p className="text-[10px] text-gray-500">Avg BA</p></div>
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">.798</p><p className="text-[10px] text-gray-500">Avg OPS</p></div>
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">4.36</p><p className="text-[10px] text-gray-500">Avg ERA</p></div>
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">9.8</p><p className="text-[10px] text-gray-500">Avg K/9</p></div>
        </div>
      </Card>

      <Card title="NCAA Division II" subtitle="Great Northwest Athletic Conference (GNAC)">
        <P>
          The GNAC features five PNW schools: Central Washington, Montana State Billings, Northwest Nazarene, Saint Martin's, and Western Oregon. D2 has the highest average ERA among PNW divisions (6.37), indicating a higher-scoring environment. Walk rates are the highest of any division (4.8 BB/9), and strikeout rates are moderate. This is a hitter-friendly environment where pitching depth is at a premium.
        </P>
        <div className="grid grid-cols-2 gap-3 my-3 text-center">
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">.275</p><p className="text-[10px] text-gray-500">Avg BA</p></div>
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">.792</p><p className="text-[10px] text-gray-500">Avg OPS</p></div>
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">6.37</p><p className="text-[10px] text-gray-500">Avg ERA</p></div>
      ...
      <Card title="NCAA Division III" subtitle="Northwest Conference (NWC)">
        <P>
          The Northwest Conference is a nine-team D3 league with strong competitive balance. D3 has the highest batting average (.284) and OPS (.811) among PNW divisions, reflecting a hitter-friendly environment. Pitching depth is the biggest challenge — ERAs average 5.90, and strikeout rates are the lowest at any level (6.9 K/9). D3 uses the same aluminum bats as other college divisions but generally faces less dominant pitching.
        </P>
        <div className="grid grid-cols-2 gap-3 my-3 text-center">
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">.284</p><p className="text-[10px] text-gray-500">Avg BA</p></div>
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">.811</p><p className="text-[10px] text-gray-500">Avg OPS</p></div>
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">5.90</p><p className="text-[10px] text-gray-500">Avg ERA</p></div>
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">6.9</p><p className="text-[10px] text-gray-500">Avg K/9</p></div>
        </div>
      </Card>

      <Card title="NAIA" subtitle="Cascade Collegiate Conference (CCC)">
        <P>
          The CCC is an eight-team NAIA conference with programs across Oregon, Idaho, and British Columbia. The run environment is similar to D3 — batting averages are high (.282), OPS is strong (.809), and pitching averages out to a 5.26 ERA. NAIA programs occupy a talent tier between D2 and D3, with some programs (like Lewis-Clark State) historically competing at a very high level.
        </P>
        <div className="grid grid-cols-2 gap-3 my-3 text-center">
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">.282</p><p className="text-[10px] text-gray-500">Avg BA</p></div>
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">.809</p><p className="text-[10px] text-gray-500">Avg OPS</p></div>
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">5.26</p><p className="text-[10px] text-gray-500">Avg ERA</p></div>
      ...
      <Card title="NWAC" subtitle="Northwest Athletic Conference — East, North, South, West Divisions">
        <P>
          The NWAC is the two-year college (JUCO) conference covering Washington and Oregon, with 28 programs across four divisions. The run environment here is the most unique in the PNW — batting averages are substantially lower (.239) and OPS is the lowest of any division (.668). This reflects a combination of shorter seasons, less experienced hitters, and the development-oriented nature of JUCO programs. Interestingly, NWAC pitching ERAs (4.50) and strikeout rates (7.7 K/9) are competitive with higher divisions, suggesting that pitching development outpaces hitting at this level.
        </P>
        <div className="grid grid-cols-2 gap-3 my-3 text-center">
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">.239</p><p className="text-[10px] text-gray-500">Avg BA</p></div>
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">.668</p><p className="text-[10px] text-gray-500">Avg OPS</p></div>
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">4.50</p><p className="text-[10px] text-gray-500">Avg ERA</p></div>
          <div className="bg-gray-50 rounded p-2"><p className="text-lg font-bold text-gray-800">7.7</p><p className="text-[10px] text-gray-500">Avg K/9</p></div>
        </div>
      </Card>
    </div>
  ...
  return (
    <div>
      <Card title="Why This Site Exists">
        <P>
          NW Baseball Stats was created to bring modern analytics to Pacific Northwest college baseball. While MLB has FanGraphs, Baseball Reference, and Statcast, college baseball — especially at the D2, D3, NAIA, and JUCO levels — has almost no publicly available advanced statistics. We wanted to change that.
        </P>
        <P>
      ...
      <Card title="How the Site Was Built" subtitle="Full transparency into our tech stack and process">
        <P>
          This entire site — frontend, backend, database, scrapers, advanced stats engine, and all — was built collaboratively by a human (Nate) and an AI (Claude by Anthropic). The AI handled the coding implementation while Nate drove the vision, design decisions, data validation, and quality control. Neither could have built this alone.
        </P>
        ...
        <div className="my-4 space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Python FastAPI serving a REST API. SQLite as the database — lightweight, portable, and more than sufficient for our data volume. The entire database is a single file that can be backed up or moved easily.
            </p>
          </div>
          <div>
