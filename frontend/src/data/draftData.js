...
export const DRAFT_DATA = {
  '26': {
    ...
    prospects: [
      ...
      { rank: 13, movement: 'up', name: 'Miles Gosztola', pos: 'LHP', year: 'JR', school: 'Oregon', playerId: 3637 },
      { rank: 14, name: 'Bryce Collins', pos: 'RHP', year: 'PREP', school: 'Kelso (WA)', commit: 'Mississippi', playerId: null },
      ...
      { rank: 16, movement: 'up', name: 'Dylan Hicks', pos: 'P', year: 'JC-2', school: 'Everett', playerId: 934 },
      { rank: 17, movement: 'up', name: 'Albert Roblez', pos: 'RHP', year: 'SR', school: 'Oregon State', playerId: 3647, report: 'Albert Roblez is a 5th-year senior, transferring to Oregon State from Long Beach State. Roblez was elite last year at LBSU, and now anchors an OSU bullpen that might be the best in the country. While a 5th-year closer isn\'t a prime draft demographic, Roblez is so damn good that he\'ll get a chance at pro ball. The righty is striking out 55.3% of batters this season, while walking just 4.3%. His 0.31 FIP is the best in the PNW and one of the best marks in the country for pitchers with 10+ IP. He\'s pitched in 11 games and collected 10 saves. It\'s an extreme over-the-top arm action that creates shapes batters rarely see. Roblez can create some really tough secondary shapes with big vertical separation off of his fastball. It\'s the type of deception and funk that organizations covet, especially in a way-underslot deal come July.', reportDate: '2026-04-13' },
      { rank: 18, name: 'Anthony Karis', pos: 'OF', year: 'PREP', school: 'Gonzaga Prep (WA)', commit: 'Uncommitted', playerId: null },
      { rank: 19, movement: 'up', name: 'Zach Edwards', pos: 'RHP', year: 'SO', school: 'Oregon State', playerId: 3657 },
      { rank: 20, movement: 'down', name: 'Collin Clarke', pos: 'P', year: 'JR', school: 'Oregon', playerId: 3624 },
      { rank: 21, movement: 'up', name: 'Payton Knowles', pos: 'UTIL', year: 'JR', school: 'Seattle U', playerId: 3687 },
      { rank: 22, movement: 'up', name: 'Nick Lewis', pos: 'LHP', year: 'R-SO', school: 'Washington State', playerId: 3658 },
      { rank: 23, name: 'Drew Smith', pos: '3B', year: 'SR', school: 'Oregon', playerId: 3500 },
      { rank: 24, movement: 'up', name: 'Max Hartman', pos: 'OF', year: 'SR', school: 'Washington State', playerId: 3534 },
      { rank: 25, name: 'Colton Bower', pos: 'C', year: 'R-JR', school: 'Washington', playerId: 3484 },
      { rank: 26, movement: 'up', name: 'Jace Taylor', pos: 'RHP', year: 'SR', school: 'LC State', playerId: 2737 },
      { rank: 27, name: 'Kealoha Kepo\'o-Sabate', pos: 'RHP', year: 'PREP', school: 'Meadowdale (WA)', commit: 'Texas Tech', playerId: null },
      { rank: 28, movement: 'up', name: 'Neal Burtis', pos: 'LHP', year: 'PREP', school: 'Tahoma (WA)', commit: 'Oregon St', playerId: null },
      { rank: 29, movement: 'down', name: 'Finbar O\'Brien', pos: 'RHP', year: 'JR', school: 'Gonzaga', playerId: 3575 },
      { rank: 30, name: 'Gavin Roy', pos: 'SS-2B', year: 'SR', school: 'Washington State', playerId: 3532 },
      { rank: 31, name: 'Trenton Hertzog', pos: 'UTIL', year: 'PREP', school: 'Tualatin (OR)', commit: 'Oregon', playerId: null },
      ...
      { rank: 41, movement: 'down', name: 'Zach Bowman', pos: 'LHP', year: 'JR', school: 'Gonzaga', playerId: 3570 },
      { rank: 42, name: 'Maddox Haley', pos: 'DH-RF', year: 'JR', school: 'Gonzaga', playerId: 3558 },
    ],
  },
  '27': {
    year: 2027,
