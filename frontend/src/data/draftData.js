...
export const DRAFT_DATA = {
  '26': {
    ...
    prospects: [
      ...
      { rank: 6,  name: 'Ryan Cooney', pos: 'IF', school: 'Oregon', playerId: 3502 },
      ...
      { rank: 20, name: 'Albert Roblez', pos: 'RHP', school: 'Oregon State', playerId: 3647 },
      ...
      { rank: 32, name: 'Jackson Jaha', pos: 'UTIL', school: 'LC State', playerId: 2714 },
      ...
      { rank: 37, name: 'Will Anderson', pos: 'LHP', school: 'British Columbia', playerId: 2994 },
      { rank: 38, name: 'Dominic Hellman', pos: 'UTIL', school: 'Oregon', playerId: 3504 },
      { rank: 39, name: 'Donny Tober', pos: 'RHP', school: 'Warner Pacific', playerId: 2950 },
      { rank: 40, name: 'Maddox Haley', pos: 'UTIL', school: 'Gonzaga', playerId: 3558 },
      { rank: 41, name: 'Austin Wolfe', pos: 'LHP', school: 'Bushnell', playerId: 2921 },
    ],
  },
  '27': {
    year: 2027,
