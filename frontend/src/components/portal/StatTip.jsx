...
export const STAT_DEFS = {
  ...
  // ── pitching ──
  stuff: ['Stuff: physical nastiness only (velo, movement, spin, extension, separation). Says nothing about command.', 'Our WCL-trained TrackMan model, anchored so 100 = an average pitch of that type in YOUR program \u2014 one fixed anchor across every season and filter. Velocity and separation off the fastball can only ever help a grade. A pitch type with a single tracked pitch gets no grade; weigh the rest by the N column.', 0],
