...
export default function StaffManager({ variant = 'card' }) {
  ...
  const seatsLine = canSeats
    ? `Your Coach & Scout subscription covers your whole staff. Add up to ${max} assistant
       coaches: each gets full Coach & Scout access on their own login, plus your TrackMan
       Suite and Rapsodo Lab data.`
    : `Add up to ${max} assistant coaches to share your TrackMan Suite and Rapsodo Lab data.
       Full membership seats for your staff come with a paid Coach & Scout subscription.`
