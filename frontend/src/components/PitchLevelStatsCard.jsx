    ...
    <StatTile
      ...
      explanation={
        <>
          ...
          probability. 1.0 = average moment. 2.0+ = closer pitching in a 1-run
          9th. Below 0.5 = mop-up duty. For hitters, a proxy for how often this
          player came up in big spots.
        </>
      }
    />
  )
...
function WpaTile({ totalWPA, peakWPA, pa, side }) {
  ...
  // Tier the season total. Calibrated from the 2026 league
  // distribution — top hitters land in the +2.0+ band.
  ...
  // Color the headline number — green for positive, red for negative
  ...
  return (
    <StatTile
      ...
      explanation={
        <>
          Win Probability Added measures the cumulative change in win
          probability from each PA. A walk-off HR in a tight game can be worth
          +0.5 in a single swing. Season totals reward production in the
          highest-leverage spots, not just rate stats.
        </>
      }
    />
  )
