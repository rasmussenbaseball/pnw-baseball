...
const TIERS = [
  ...
  },
  {
    ...
    perks: [
      ...
      'Premium articles + Commitments feed',
      'Park Factors + advanced stats',
      '7-day free trial',
    ],
  },
  {
    ...
    perks: [
      ...
      'Lineup helper + bullpen sheets',
      'Printable scouting PDFs + catcher cards',
      'JUCO Tracker + Trends + Historic matchups',
...
export default function SignupPopup() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-sm overflow-y-auto">
      {/* Close button — fixed to viewport so it stays reachable while the
          long modal content scrolls underneath. Also bumped up to a 44px
          touch target on mobile (Apple HIG minimum). z-index above the
          modal card so it never gets covered. */}
      <button
        onClick={dismiss}
        aria-label="Close"
