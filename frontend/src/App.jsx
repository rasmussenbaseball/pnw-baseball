          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">
                Created by{' '}
                <a href="https://x.com/RasmussenBase" target="_blank" rel="noopener noreferrer" className="text-nw-teal hover:underline">Nate Rasmussen</a>
              </p>
            </div>

            {/* Links */}
            <div>
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Site</p>
              <div className="space-y-1.5">
                <a href="/about" className="block text-xs text-gray-300 hover:text-nw-teal transition-colors">About & Methodology</a>
                <a href="/about#glossary" className="block text-xs text-gray-300 hover:text-nw-teal transition-colors">Stat Glossary</a>
                <a href="/about#environments" className="block text-xs text-gray-300 hover:text-nw-teal transition-colors">Run Environments</a>
                <a href="/about#updates" className="block text-xs text-gray-300 hover:text-nw-teal transition-colors">Site Updates</a>
              </div>
            </div>

            {/* Data + Social */}
            <div>
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Data Sources</p>
              <div className="space-y-1.5 mb-4">
                <p className="text-xs text-gray-400">D1/D2/D3/NAIA via Sidearm Sports</p>
                <p className="text-xs text-gray-400">NWAC via PrestoSports</p>
                <p className="text-xs text-gray-400">Summer leagues via PointStreak</p>
              </div>
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Follow</p>
              <div className="flex items-center gap-3">
                <a href="https://x.com/NWBBStats" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="X (Twitter)">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                <a href="https://instagram.com/nwbbstats" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="Instagram">
